# Generated by Powerlevel10k configuration wizard on 2022-09-19 at 23:41 EDT.
...
# 1 line, compact, many icons, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='󰊪'
